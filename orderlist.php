                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                while($row=$select->fetch(PDO::FETCH_OBJ)){
                                    ...
                                    <td>
                                     <a href="invoice_db.php?id='.$row->invoice_id.'" class="btn btn-warning" role="button" title="Print Invoice" target="_blank"><i style="color:#ffffff" data-toggle="tooltip" class="fa fa-print" ></i> <span></span></a>
